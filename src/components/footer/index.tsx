...
export function XFooter() {
  return (
    <MainLayout>
      <div className="flex justify-between items-center border-t border-[rgba(255,255,255,0.1)] pt-[46px] mt-[130px] pb-[130px]">
        <div>
        ...
        <div className="flex text-base text-white gap-x-[100px]">
          ...
          <div>
            ...
            <div className="flex items-center mt-6">
              <div className="text-80">FAQ</div>
            </div>
            <div className="flex items-center mt-8">
              <div className="text-80">Privacy Policy</div>
            </div>
            <div className="flex items-center mt-8">
              <div className="text-80">Terms of Service</div>
            </div>
          </div>
          <div>
