  ...
  return (
    <div className="h-[88px] flex items-center justify-between px-5 sticky left-0 top-0 w-full bg-[#06070A] z-[49] header-menu">
      <div className="flex items-center">
        ...
        <img src="/images/home/new/logo.png" className="w-[206px]" alt="" />
        
      </div>
      <div className="flex items-center gap-x-2 shrink-0">
        <HomeButton onClick={() => router.push('/lite-trade')} type="launch" className="h-[41px]" >{t('newHome.btn1')}</HomeButton>
