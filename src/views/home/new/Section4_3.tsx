    ...
    return (
      ...
      >
        <div className=" font-normal flex items-center justify-between">
          <div className=" text-[16px]">GOOGLc</div>
          <div className=" text-[16px]">$203.22 </div>
        </div>
        <div className=" font-normal flex items-center justify-between">
          <div className=" text-[14px] text-[rgba(255,255,255,0.6)] mt-[2]">Google</div>
          <div className=" text-[12px] text-[rgba(46,189,133,1)] h-[19px] rounded-[4px] min-w-[59px] px-[8px] flex items-center justify-center bg-[rgba(255,255,255,0.1)]">+2.98%</div>
        </div>
      </div>
    )
  }
