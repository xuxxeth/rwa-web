      ...
      <div className="w-[1440px] h-[367px] relative">
        ...
        <div className=" relative z-10 h-full flex items-center text-white pl-[158px]">
          <div className="w-[520px]">
            ...
            <div className="text-[16px] mt-4">Harness dynamic token issuance and redemption mechanism, seamlessly integrated with DeFi protocols and backed by secure custodial structures. Access real-world financial liquidity directly on-chain.</div>
          </div>
        </div>
      </div>
    </div>
