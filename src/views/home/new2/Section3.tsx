...
const Section3Lg = memo(({ scrollY, locked }: {scrollY: MotionValue, locked: boolean}) => {
...
const Section3 = ({ scrollY, locked }: {scrollY: MotionValue, locked: boolean}) => {
  return (
    <>
      <Section3Lg scrollY={scrollY} locked={locked} />
      <Section3H5 />
    </>
  )
}
